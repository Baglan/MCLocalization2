...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        let remoteProvider = MCLocalization.JSONProvider(remoteURL: URL(string: "https://github.com/Baglan/MCLocalization2/raw/master/MCLocalization2/remote-en-ru.json")!, localName: "remote-en-ru.json")
